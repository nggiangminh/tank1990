...
public class Images {
    ...
    public static final Image PLAYER_UP_2 = new ImageIcon(folderPath + "playerTank_up_2.png").getImage();
    public static final Image PLAYER_DOWN_1 = new ImageIcon(folderPath + "playerTank_down.png").getImage();
    public static final Image PLAYER_DOWN_2 = new ImageIcon(folderPath + "playerTank_down_2.png").getImage();
    public static final Image PLAYER_LEFT_1 = new ImageIcon(folderPath + "playerTank_left.png").getImage();
    public static final Image PLAYER_LEFT_2 = new ImageIcon(folderPath + "playerTank_left_2.png").getImage();
    public static final Image PLAYER_RIGHT_1 = new ImageIcon(folderPath + "playerTank_right.png").getImage();
    public static final Image PLAYER_RIGHT_2 = new ImageIcon(folderPath + "playerTank_right_2.png").getImage();

    //Armor Tank Images
    public static final Image ARMOR_UP_1 = new ImageIcon(folderPath + "tank_armor_up.png").getImage();
    public static final Image ARMOR_UP_2 = new ImageIcon(folderPath + "tank_armor_up_2.png").getImage();
    public static final Image ARMOR_DOWN_1 = new ImageIcon(folderPath + "tank_armor_down.png").getImage();
    public static final Image ARMOR_DOWN_2 = new ImageIcon(folderPath + "tank_armor_down_2.png").getImage();
    public static final Image ARMOR_LEFT_1 = new ImageIcon(folderPath + "tank_armor_left.png").getImage();
    public static final Image ARMOR_LEFT_2 = new ImageIcon(folderPath + "tank_armor_left_2.png").getImage();
    public static final Image ARMOR_RIGHT_1 = new ImageIcon(folderPath + "tank_armor_right.png").getImage();
    public static final Image ARMOR_RIGHT_2 = new ImageIcon(folderPath + "tank_armor_right_2.png").getImage();

    public static final Image ARMOR_UP_1_F= new ImageIcon(folderPath + "tank_armor_up_f.png").getImage();
    public static final Image ARMOR_UP_2_F = new ImageIcon(folderPath + "tank_armor_up_2_f.png").getImage();
    public static final Image ARMOR_DOWN_1_F = new ImageIcon(folderPath + "tank_armor_down_f.png").getImage();
    public static final Image ARMOR_DOWN_2_F = new ImageIcon(folderPath + "tank_armor_down_2_f.png").getImage();
    public static final Image ARMOR_LEFT_1_F = new ImageIcon(folderPath + "tank_armor_left_f.png").getImage();
    public static final Image ARMOR_LEFT_2_F = new ImageIcon(folderPath + "tank_armor_left_2_f.png").getImage();
    public static final Image ARMOR_RIGHT_1_F = new ImageIcon(folderPath + "tank_armor_right_f.png").getImage();
